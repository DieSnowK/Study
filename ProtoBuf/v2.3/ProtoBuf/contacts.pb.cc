...
PROTOBUF_CONSTEXPR PeopleInfo::PeopleInfo(
  ...
  , /*decltype(_impl_.ohter_contact_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ::_pbi::kInvalidFieldOffsetTag,
  PROTOBUF_FIELD_OFFSET(::contacts2::PeopleInfo, _impl_.ohter_contact_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_contacts_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "obuf/any.proto\"5\n\007Address\022\024\n\014home_addres"
  "s\030\001 \001(\t\022\024\n\014unit_address\030\002 \001(\t\"\224\002\n\nPeople"
  ...
  "er\030\001 \001(\t\0223\n\004type\030\002 \001(\0162%.contacts2.Peopl"
  "eInfo.Phone.PhoneType\"\034\n\tPhoneType\022\006\n\002MP"
  "\020\000\022\007\n\003TEL\020\001B\017\n\rohter_contact\"3\n\010Contacts"
  "\022\'\n\010contacts\030\001 \003(\0132\025.contacts2.PeopleInf"
  "ob\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_contacts_2eproto = {
    false, false, 449, descriptor_table_protodef_contacts_2eproto,
    "contacts.proto",
...
PeopleInfo::PeopleInfo(const PeopleInfo& from)
  ...
  switch (from.ohter_contact_case()) {
    case kQq: {
...
void PeopleInfo::InternalSwap(PeopleInfo* other) {
  ...
  swap(_impl_.ohter_contact_, other->_impl_.ohter_contact_);
