...
void PrintContacts(contacts2::Contacts& contacts)
{
    for (int i = 0; i < contacts.contacts_size(); i++)
    {
        ...
        switch (people.ohter_contact_case()) // _case直接拿到当前oneof设置了什么字段
        {
        case contacts2::PeopleInfo::OhterContactCase::kQq:
            cout << "联系人QQ:" << people.qq() << endl;
            break;
        case contacts2::PeopleInfo::OhterContactCase::kWechat:
            cout << "联系人VX:" << people.wechat() << endl;
            break;
        default:
            break;
        }
