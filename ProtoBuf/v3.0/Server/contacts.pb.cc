...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::s_contacts3::PeopleInfo_Phone, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::s_contacts3::PeopleInfo_Phone, _impl_.number_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::s_contacts3::PeopleInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::s_contacts3::PeopleInfo, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::s_contacts3::PeopleInfo, _impl_.birthday_),
  PROTOBUF_FIELD_OFFSET(::s_contacts3::PeopleInfo, _impl_.phone_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::s_contacts3::Contacts, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::s_contacts3::Contacts, _impl_.contacts_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::s_contacts3::PeopleInfo_Phone)},
  { 7, -1, -1, sizeof(::s_contacts3::PeopleInfo)},
  { 16, -1, -1, sizeof(::s_contacts3::Contacts)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::s_contacts3::_PeopleInfo_Phone_default_instance_._instance,
  &::s_contacts3::_PeopleInfo_default_instance_._instance,
  &::s_contacts3::_Contacts_default_instance_._instance,
};

const char descriptor_table_protodef_contacts_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016contacts.proto\022\013s_contacts3\"y\n\nPeopleI"
  "nfo\022\014\n\004name\030\001 \001(\t\022\020\n\010birthday\030\004 \001(\005\022,\n\005p"
  "hone\030\003 \003(\0132\035.s_contacts3.PeopleInfo.Phon"
  "e\032\027\n\005Phone\022\016\n\006number\030\001 \001(\tJ\004\010\002\020\003\"5\n\010Cont"
  "acts\022)\n\010contacts\030\001 \003(\0132\027.s_contacts3.Peo"
  "pleInfob\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_contacts_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_contacts_2eproto = {
    false, false, 215, descriptor_table_protodef_contacts_2eproto,
    "contacts.proto",
...
PeopleInfo_Phone::PeopleInfo_Phone(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:s_contacts3.PeopleInfo.Phone)
}
PeopleInfo_Phone::PeopleInfo_Phone(const PeopleInfo_Phone& from)
  ...
  // @@protoc_insertion_point(copy_constructor:s_contacts3.PeopleInfo.Phone)
}
...
PeopleInfo_Phone::~PeopleInfo_Phone() {
  // @@protoc_insertion_point(destructor:s_contacts3.PeopleInfo.Phone)
...
// @@protoc_insertion_point(message_clear_start:s_contacts3.PeopleInfo.Phone)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "s_contacts3.PeopleInfo.Phone.number"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* PeopleInfo_Phone::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:s_contacts3.PeopleInfo.Phone)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_number().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "s_contacts3.PeopleInfo.Phone.number");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:s_contacts3.PeopleInfo.Phone)
  return target;
}

size_t PeopleInfo_Phone::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:s_contacts3.PeopleInfo.Phone)
  size_t total_size = 0;
...
void PeopleInfo_Phone::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:s_contacts3.PeopleInfo.Phone)
...
// @@protoc_insertion_point(class_specific_copy_from_start:s_contacts3.PeopleInfo.Phone)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PeopleInfo::PeopleInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:s_contacts3.PeopleInfo)
}
PeopleInfo::PeopleInfo(const PeopleInfo& from)
  ...
  // @@protoc_insertion_point(copy_constructor:s_contacts3.PeopleInfo)
}
...
PeopleInfo::~PeopleInfo() {
  // @@protoc_insertion_point(destructor:s_contacts3.PeopleInfo)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:s_contacts3.PeopleInfo)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "s_contacts3.PeopleInfo.name"));
        } else
          goto handle_unusual;
        continue;
...
uint8_t* PeopleInfo::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:s_contacts3.PeopleInfo)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:s_contacts3.PeopleInfo)
  return target;
}

size_t PeopleInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:s_contacts3.PeopleInfo)
  size_t total_size = 0;
...
void PeopleInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:s_contacts3.PeopleInfo)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:s_contacts3.PeopleInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
Contacts::Contacts(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:s_contacts3.Contacts)
}
Contacts::Contacts(const Contacts& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:s_contacts3.Contacts)
}
...
Contacts::~Contacts() {
  // @@protoc_insertion_point(destructor:s_contacts3.Contacts)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
void Contacts::Clear() {
// @@protoc_insertion_point(message_clear_start:s_contacts3.Contacts)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* Contacts::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:s_contacts3.Contacts)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:s_contacts3.Contacts)
  return target;
}

size_t Contacts::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:s_contacts3.Contacts)
  size_t total_size = 0;
...
void Contacts::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:s_contacts3.Contacts)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:s_contacts3.Contacts)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::s_contacts3::PeopleInfo_Phone*
Arena::CreateMaybeMessage< ::s_contacts3::PeopleInfo_Phone >(Arena* arena) {
  return Arena::CreateMessageInternal< ::s_contacts3::PeopleInfo_Phone >(arena);
}
template<> PROTOBUF_NOINLINE ::s_contacts3::PeopleInfo*
Arena::CreateMaybeMessage< ::s_contacts3::PeopleInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::s_contacts3::PeopleInfo >(arena);
}
template<> PROTOBUF_NOINLINE ::s_contacts3::Contacts*
Arena::CreateMaybeMessage< ::s_contacts3::Contacts >(Arena* arena) {
  return Arena::CreateMessageInternal< ::s_contacts3::Contacts >(arena);
}
