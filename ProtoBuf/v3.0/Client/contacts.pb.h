...
PROTOBUF_NAMESPACE_OPEN
template<> ::c_contacts3::Contacts* Arena::CreateMaybeMessage<::c_contacts3::Contacts>(Arena*);
template<> ::c_contacts3::PeopleInfo* Arena::CreateMaybeMessage<::c_contacts3::PeopleInfo>(Arena*);
template<> ::c_contacts3::PeopleInfo_Phone* Arena::CreateMaybeMessage<::c_contacts3::PeopleInfo_Phone>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace c_contacts3 {
...
class PeopleInfo_Phone final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:c_contacts3.PeopleInfo.Phone) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "c_contacts3.PeopleInfo.Phone";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:c_contacts3.PeopleInfo.Phone)
 private:
  class _Internal;
...
class PeopleInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:c_contacts3.PeopleInfo) */ {
 public:
  ...
  // repeated .c_contacts3.PeopleInfo.Phone phone = 3;
  int phone_size() const;
  private:
  int _internal_phone_size() const;
  public:
  void clear_phone();
  ::c_contacts3::PeopleInfo_Phone* mutable_phone(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts3::PeopleInfo_Phone >*
      mutable_phone();
  private:
  const ::c_contacts3::PeopleInfo_Phone& _internal_phone(int index) const;
  ::c_contacts3::PeopleInfo_Phone* _internal_add_phone();
  public:
  const ::c_contacts3::PeopleInfo_Phone& phone(int index) const;
  ::c_contacts3::PeopleInfo_Phone* add_phone();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts3::PeopleInfo_Phone >&
      phone() const;
  ...
  // @@protoc_insertion_point(class_scope:c_contacts3.PeopleInfo)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts3::PeopleInfo_Phone > phone_;
...
class Contacts final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:c_contacts3.Contacts) */ {
 public:
  ...
  // repeated .c_contacts3.PeopleInfo contacts = 1;
  int contacts_size() const;
  private:
  int _internal_contacts_size() const;
  public:
  void clear_contacts();
  ::c_contacts3::PeopleInfo* mutable_contacts(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts3::PeopleInfo >*
      mutable_contacts();
  private:
  const ::c_contacts3::PeopleInfo& _internal_contacts(int index) const;
  ::c_contacts3::PeopleInfo* _internal_add_contacts();
  public:
  const ::c_contacts3::PeopleInfo& contacts(int index) const;
  ::c_contacts3::PeopleInfo* add_contacts();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts3::PeopleInfo >&
      contacts() const;

  // @@protoc_insertion_point(class_scope:c_contacts3.Contacts)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts3::PeopleInfo > contacts_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_contacts_2eproto;
...
inline const std::string& PeopleInfo_Phone::number() const {
  // @@protoc_insertion_point(field_get:c_contacts3.PeopleInfo.Phone.number)
...
void PeopleInfo_Phone::set_number(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.number_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:c_contacts3.PeopleInfo.Phone.number)
}
inline std::string* PeopleInfo_Phone::mutable_number() {
  std::string* _s = _internal_mutable_number();
  // @@protoc_insertion_point(field_mutable:c_contacts3.PeopleInfo.Phone.number)
  return _s;
}
...
inline std::string* PeopleInfo_Phone::release_number() {
  // @@protoc_insertion_point(field_release:c_contacts3.PeopleInfo.Phone.number)
...
inline void PeopleInfo_Phone::set_allocated_number(std::string* number) {
  ...
  // @@protoc_insertion_point(field_set_allocated:c_contacts3.PeopleInfo.Phone.number)
}
...
inline const std::string& PeopleInfo::name() const {
  // @@protoc_insertion_point(field_get:c_contacts3.PeopleInfo.name)
...
void PeopleInfo::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:c_contacts3.PeopleInfo.name)
}
inline std::string* PeopleInfo::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:c_contacts3.PeopleInfo.name)
  return _s;
}
...
inline std::string* PeopleInfo::release_name() {
  // @@protoc_insertion_point(field_release:c_contacts3.PeopleInfo.name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:c_contacts3.PeopleInfo.name)
}
...
inline int32_t PeopleInfo::age() const {
  // @@protoc_insertion_point(field_get:c_contacts3.PeopleInfo.age)
...
inline void PeopleInfo::set_age(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:c_contacts3.PeopleInfo.age)
}
...
inline ::c_contacts3::PeopleInfo_Phone* PeopleInfo::mutable_phone(int index) {
  // @@protoc_insertion_point(field_mutable:c_contacts3.PeopleInfo.phone)
  return _impl_.phone_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts3::PeopleInfo_Phone >*
PeopleInfo::mutable_phone() {
  // @@protoc_insertion_point(field_mutable_list:c_contacts3.PeopleInfo.phone)
  return &_impl_.phone_;
}
inline const ::c_contacts3::PeopleInfo_Phone& PeopleInfo::_internal_phone(int index) const {
  return _impl_.phone_.Get(index);
}
inline const ::c_contacts3::PeopleInfo_Phone& PeopleInfo::phone(int index) const {
  // @@protoc_insertion_point(field_get:c_contacts3.PeopleInfo.phone)
  return _internal_phone(index);
}
inline ::c_contacts3::PeopleInfo_Phone* PeopleInfo::_internal_add_phone() {
  return _impl_.phone_.Add();
}
inline ::c_contacts3::PeopleInfo_Phone* PeopleInfo::add_phone() {
  ::c_contacts3::PeopleInfo_Phone* _add = _internal_add_phone();
  // @@protoc_insertion_point(field_add:c_contacts3.PeopleInfo.phone)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts3::PeopleInfo_Phone >&
PeopleInfo::phone() const {
  // @@protoc_insertion_point(field_list:c_contacts3.PeopleInfo.phone)
  return _impl_.phone_;
}
...
inline ::c_contacts3::PeopleInfo* Contacts::mutable_contacts(int index) {
  // @@protoc_insertion_point(field_mutable:c_contacts3.Contacts.contacts)
  return _impl_.contacts_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts3::PeopleInfo >*
Contacts::mutable_contacts() {
  // @@protoc_insertion_point(field_mutable_list:c_contacts3.Contacts.contacts)
  return &_impl_.contacts_;
}
inline const ::c_contacts3::PeopleInfo& Contacts::_internal_contacts(int index) const {
  return _impl_.contacts_.Get(index);
}
inline const ::c_contacts3::PeopleInfo& Contacts::contacts(int index) const {
  // @@protoc_insertion_point(field_get:c_contacts3.Contacts.contacts)
  return _internal_contacts(index);
}
inline ::c_contacts3::PeopleInfo* Contacts::_internal_add_contacts() {
  return _impl_.contacts_.Add();
}
inline ::c_contacts3::PeopleInfo* Contacts::add_contacts() {
  ::c_contacts3::PeopleInfo* _add = _internal_add_contacts();
  // @@protoc_insertion_point(field_add:c_contacts3.Contacts.contacts)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts3::PeopleInfo >&
Contacts::contacts() const {
  // @@protoc_insertion_point(field_list:c_contacts3.Contacts.contacts)
  return _impl_.contacts_;
}
