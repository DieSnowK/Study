...
class PeopleInfo final :
 ...
 public:
  ...
  enum OhterContactCase {
    kQq = 5,
    kWechat = 6,
    OHTER_CONTACT_NOT_SET = 0,
  };
  ...
  void clear_ohter_contact();
  OhterContactCase ohter_contact_case() const;
 ...
 private:
  ...
  inline bool has_ohter_contact() const;
  inline void clear_has_ohter_contact();
  ...
  struct Impl_ {
    ...
    int32_t age_;
    union OhterContactUnion {
      constexpr OhterContactUnion() : _constinit_{} {}
...
inline void PeopleInfo::clear_qq() {
  if (_internal_has_qq()) {
    _impl_.ohter_contact_.qq_.Destroy();
    clear_has_ohter_contact();
  }
}
...
inline void PeopleInfo::set_qq(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_qq()) {
    clear_ohter_contact();
    set_has_qq();
    _impl_.ohter_contact_.qq_.InitDefault();
  }
  _impl_.ohter_contact_.qq_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& PeopleInfo::_internal_qq() const {
  if (_internal_has_qq()) {
    return _impl_.ohter_contact_.qq_.Get();
  }
...
inline void PeopleInfo::_internal_set_qq(const std::string& value) {
  ...
  _impl_.ohter_contact_.qq_.Set(value, GetArenaForAllocation());
}
inline std::string* PeopleInfo::_internal_mutable_qq() {
  ...
  return _impl_.ohter_contact_.qq_.Mutable(      GetArenaForAllocation());
}
inline std::string* PeopleInfo::release_qq() {
  // @@protoc_insertion_point(field_release:contacts2.PeopleInfo.qq)
  if (_internal_has_qq()) {
    clear_has_ohter_contact();
    return _impl_.ohter_contact_.qq_.Release();
  } else {
    return nullptr;
  }
}
inline void PeopleInfo::set_allocated_qq(std::string* qq) {
  if (has_ohter_contact()) {
    clear_ohter_contact();
  }
  if (qq != nullptr) {
    set_has_qq();
    _impl_.ohter_contact_.qq_.InitAllocated(qq, GetArenaForAllocation());
  }
...
inline bool PeopleInfo::_internal_has_wechat() const {
  return ohter_contact_case() == kWechat;
}
...
inline void PeopleInfo::clear_wechat() {
  if (_internal_has_wechat()) {
    _impl_.ohter_contact_.wechat_.Destroy();
    clear_has_ohter_contact();
  }
}
...
inline void PeopleInfo::set_wechat(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_wechat()) {
    clear_ohter_contact();
    set_has_wechat();
    _impl_.ohter_contact_.wechat_.InitDefault();
  }
  _impl_.ohter_contact_.wechat_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& PeopleInfo::_internal_wechat() const {
  if (_internal_has_wechat()) {
    return _impl_.ohter_contact_.wechat_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void PeopleInfo::_internal_set_wechat(const std::string& value) {
  ...
  _impl_.ohter_contact_.wechat_.Set(value, GetArenaForAllocation());
}
inline std::string* PeopleInfo::_internal_mutable_wechat() {
  ...
  return _impl_.ohter_contact_.wechat_.Mutable(      GetArenaForAllocation());
}
inline std::string* PeopleInfo::release_wechat() {
  // @@protoc_insertion_point(field_release:contacts2.PeopleInfo.wechat)
  if (_internal_has_wechat()) {
    clear_has_ohter_contact();
    return _impl_.ohter_contact_.wechat_.Release();
  } else {
    return nullptr;
  }
}
inline void PeopleInfo::set_allocated_wechat(std::string* wechat) {
  ...
  if (wechat != nullptr) {
    set_has_wechat();
    _impl_.ohter_contact_.wechat_.InitAllocated(wechat, GetArenaForAllocation());
  }
...
inline bool PeopleInfo::has_ohter_contact() const {
  return ohter_contact_case() != OHTER_CONTACT_NOT_SET;
}
inline void PeopleInfo::clear_has_ohter_contact() {
  _impl_._oneof_case_[0] = OHTER_CONTACT_NOT_SET;
}
inline PeopleInfo::OhterContactCase PeopleInfo::ohter_contact_case() const {
  return PeopleInfo::OhterContactCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------
